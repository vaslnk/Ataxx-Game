...
class Move {
    ...
    boolean isExtend() {
        int colDIF = Math.abs(col0() - col1());
        int rowDIF = Math.abs(row0() - row1());
        return (colDIF == 1 && rowDIF <= 1) || (rowDIF == 1 && colDIF <= 1);
    }
    ...
    public String toString() {
        ...
        String all;
        all = Character.toString(col0()) + Character.toString(row0()) + "-"
